...
- <https://www.youtube.com/c/DeFiChainDE> DeFiChain (Deutsch) 

## Tax return tool (Independent of DeFiChain)

- <https://chain.report/de/ Chainreport is a tool for creating tax returns.Very suitable for DeFiChain.
